...
{
public:
	CTraceFilterSkientity(C_BaseEntity* entityHandle)
	{
		pSkip = entityHandle;
	}
...
{
public:
	CTraceFilterPlayersOnlySkipOne(C_BaseEntity* ent)
	{
		ent = ent;
	}
	bool ShouldHitEntity(C_BaseEntity* entityHandle, int /*contentsMask*/)
	{
		//return entityHandle != ent && entityHandle->IsPlayer(); //lil anti paste :)
		return true;
	}
	virtual TraceType GetTraceType() const
	{
...
{
public:
	CTraceFilterSkipTwoEntities(C_BaseEntity* ent1, C_BaseEntity* ent2)
	{
		ent1 = ent1;
		ent2 = ent2;
	}
	bool ShouldHitEntity(C_BaseEntity* entityHandle, int /*contentsMask*/)
	{
		return !(entityHandle == ent1 || entityHandle == ent2);
	}
	virtual TraceType GetTraceType() const
	{
		return TraceType::TRACE_EVERYTHING;
...
{
	void* plane;               // The plane of the brush side
...
{
public:
	virtual int   GetPointContents(const Vector &vecAbsPosition, int contentsMask = MASK_ALL, C_BaseEntity** pentity = nullptr) = 0;
	virtual int   GetPointContents_WorldOnly(const Vector &vecAbsPosition, int contentsMask = MASK_ALL) = 0;
	virtual int   GetPointContents_Collideable(ICollideable *pCollide, const Vector &vecAbsPosition) = 0;
	virtual void  ClipRayToEntity(const Ray_t &ray, unsigned int fMask, C_BaseEntity *ent, CGameTrace *pTrace) = 0;
