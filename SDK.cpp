...
void InitialThread(void)
{
	...
	g_Utils->Print(@"       .__                   __   _______                         ");
	g_Utils->Print(@"  ____ |  |__   ____ _____ _/  |_ \      \ _____    _____   ____  	");
	g_Utils->Print(@"_/ ___\|  |  \_/ __ \\__  \\   __\/   |   \\__  \  /     \_/ __ \ ");
	g_Utils->Print(@"\  \___|   Y  \  ___/ / __ \|  | /    |    \/ __ \|  Y Y  \  ___/ ");
	g_Utils->Print(@" \___  >___|  /\___  >____  /__| \____|__  (____  /__|_|  /\___  >");
	g_Utils->Print(@"     \/     \/     \/     \/             \/     \/      \/     \/ ");
	g_Utils->Print("");
